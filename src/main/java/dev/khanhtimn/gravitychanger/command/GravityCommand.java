package dev.khanhtimn.gravitychanger.command;
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        builder.then(Commands.literal("view")
                .executes(context -> {
                    ...
                    GravityData data = GravityChangerAPI.getGravityData(Objects.requireNonNull(entity));

                    context.getSource().sendSuccess(
                            () -> Component.translatable(
                                    "gravity_changer.command.inform",
                                    data.getBaseGravityDirection().getName(),
                                    data.getBaseGravityStrength()
                            ), false
                    );
