...
//
//    @Override
//    public void prepare(@NotNull PathNavigationRegion p_77620_, @NotNull Mob p_77621_) {
...
//        BlockState blockstate = this.currentContext.getBlockState(blockpos$mutableblockpos.set(blockPos));
...
//                    blockstate = this.currentContext.getBlockState(blockpos$mutableblockpos.set(blockPos));
//                }
...
//                int i = 0;
//                BlockPos blockpos;
//                for (blockpos = this.mob.blockPosition(); (this.currentContext.getBlockState(blockpos).isAir() || this.currentContext.getBlockState(blockpos).isPathfindable(this.currentContext, blockpos, PathComputationType.LAND)) && i < this.mob.level.getMaxBuildHeight(); blockpos = blockpos.relative(this.gravityDirection)) {
//                    i++;
//                }
//                blockPos = blockpos.relative(this.gravityDirection.getOpposite());
//            }
